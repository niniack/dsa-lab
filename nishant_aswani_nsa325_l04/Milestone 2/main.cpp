...
int main(){
  ...
  cout << "There are three functionalities: put, remove, and print." << endl;
  ...
  cout << "If the Abu Dhabi government is seeking to remove Abu Dhabi mall, " << endl;
  cout << "we can simply use the remove('Abu Dhabi Mall') functionality";
  cout << endl << endl;
  list.remove("Abu Dhabi Mall");
  list.print();
  list.remove("dog");
